...
import { categorizeFilesWithNvidiaNim } from "@/lib/ai-categorize"
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const categorizations = await categorizeFilesWithNvidiaNim(files)
    ...
    const errorMessage = error instanceof Error ? error.message : "Failed to categorize files with NVIDIA NIM"
