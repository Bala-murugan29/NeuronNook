...
export function DriveIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path
        d="M7.71 3.5L1.15 15l3.43 6L11.14 9.5 7.71 3.5zM8.29 3.5h6.86l6.56 11.5H8.85L8.29 3.5zM22.85 15L15.86 15l-3.43 6h10.99l-.57-1z"
        fill="#4285F4"
      />
      <path d="M8.29 3.5L1.15 15l3.43 6L15.86 15l6.56-11.5H8.29z" fill="#0F9D58" />
      <path d="M4.58 21l3.43-6h14.99l-3.43 6H4.58z" fill="#FBBC05" />
    </svg>
  )
}
